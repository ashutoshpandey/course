    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class='tab-container'>
                ...
                <div id='tab-list'>
                    <div id='courier-list' class='list-container'></div>
                </div>
                <div id='tab-create'>
                    <div id='form-container'>
                        <form id='form-create-courier'>
                            ...
                            <div class='form-row'>
                                ...
                                <div class='form-data'>
                                    <textarea name='land_mark'></textarea>
                                </div>
                                <div class='clear'></div>
                            </div>
                            <div class='form-row'>
                            ...
                            <div class='form-row'>
                                ...
                                <div class='form-data'>
                                    <input type='button' name='btn-create' value="Create Courier" class='half'/> <br/><br/><span
                                            class='message'></span>
                                </div>
                                <div class='clear'></div>
                            </div>
