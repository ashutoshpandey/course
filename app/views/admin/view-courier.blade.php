                    ...
                    <div id='form-container'>
                        <form id='form-update-courier'>
                            <div class='form-row'>
                                ...
                                <div class='form-data'>
                                    <input type='text' name='contact_person' value='{{$courier->contact_person}}'/>
                                </div>
                                <div class='clear'></div>
                            </div>
                            <div class='form-row'>
                            ...
                            <div class='form-row'>
                                ...
                                <div class='form-data'>
                                    <input type='text' name='contact_number_1' value='{{$courier->contact_number_1}}'/>
                                </div>
                                <div class='form-label'>Contact number 2</div>
                                <div class='form-data'>
                                    <input type='text' name='contact_number_2' value='{{$courier->contact_number_2}}'/>
                                </div>
                                <div class='clear'></div>
                            </div>
                            <div class='form-row'>
...
{{HTML::script(asset("/public/js/site/admin/view-courier.js"))}}
</body>
</html>
